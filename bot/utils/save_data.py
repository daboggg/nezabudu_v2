...
async def save_data(state: FSMContext, bot: Bot, session: AsyncSession, apscheduler: AsyncIOScheduler, user_id: int):
    # сохранить в бд задание
    remind_id = await add_remind_to_db(state, session, user_id)
